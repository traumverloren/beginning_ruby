...
# get a direction input from player

puts "Pick a direction to start your journey in the Dungeon!  Please type 'south', 'north', 'east', 'west' or type 'exit' to quit the game!"
player_input = gets.chomp.downcase.to_sym


while player_input == :south || player_input == :north || player_input == :east || player_input == :west || player_input == :exit
  if player_input == :exit
    break
  end
  my_dungeon.start(player_input)
  puts "What to try another direction?"
end

#  puts "Sorry, I didn't understand that. Please type 'south', 'north', 'east', 'west' or type 'exit' to quit the game!"


  #until player_input == :north || player_input == :south || player_input == :east || player_input == :west || player_input == :exit
    #puts "Try again! Please type 'south', 'north', 'east', 'west' or type 'exit' to quit the game!"
    #player_input = gets.chomp.downcase.to_sym
  #end
